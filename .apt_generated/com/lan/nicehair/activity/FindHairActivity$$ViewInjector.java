...
public class FindHairActivity$$ViewInjector {
  public static void inject(Finder finder, final com.lan.nicehair.activity.FindHairActivity target, Object source) {
    View view;
    view = finder.findById(source, 2131165254);
    if (view == null) {
      throw new IllegalStateException("Required view with id '2131165254' for field 'mRadioGroup' was not found. If this view is optional add '@Optional' annotation.");
    }
    target.mRadioGroup = (android.widget.RadioGroup) view;
    view = finder.findById(source, 2131165250);
    if (view == null) {
      throw new IllegalStateException("Required view with id '2131165250' for field 'mViewPager' was not found. If this view is optional add '@Optional' annotation.");
    }
