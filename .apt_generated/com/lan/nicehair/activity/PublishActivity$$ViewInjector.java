...
public class PublishActivity$$ViewInjector {
  public static void inject(Finder finder, final com.lan.nicehair.activity.PublishActivity target, Object source) {
    ...
    view = finder.findById(source, 2131165639);
    if (view == null) {
      throw new IllegalStateException("Required view with id '2131165639' for field 'mGridView' was not found. If this view is optional add '@Optional' annotation.");
    }
