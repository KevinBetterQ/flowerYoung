...
public class TopicSearchActivity$$ViewInjector {
  public static void inject(Finder finder, final com.lan.nicehair.activity.TopicSearchActivity target, Object source) {
    View view;
    view = finder.findById(source, 2131165293);
    if (view == null) {
      throw new IllegalStateException("Required view with id '2131165293' for field 'mIvClear' was not found. If this view is optional add '@Optional' annotation.");
    }
    target.mIvClear = (android.widget.ImageView) view;
    view = finder.findById(source, 2131165291);
    if (view == null) {
      throw new IllegalStateException("Required view with id '2131165291' for method 'onCancelClicked' was not found. If this view is optional add '@Optional' annotation.");
    }
