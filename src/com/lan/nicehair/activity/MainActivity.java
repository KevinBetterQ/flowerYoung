...
public class MainActivity extends ActivityGroup {
	...
	private void addTabIntent() {
		...
		this.mTabHost.addTab(buildTabSpec("tab3","2",new Intent(this,FlowerMarketActivity.class)));
		this.mTabHost.addTab(buildTabSpec("tab4","3",new Intent(this,MeActivity.class)));
		
		this.mTabHost.addTab(buildTabSpec("tab4","4",new Intent(this,DisCoverActivity.class)));
	}
}
