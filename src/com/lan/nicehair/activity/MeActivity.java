...
public class MeActivity extends BaseActivity implements OnDialogListener {
	...
	@OnClick(R.id.dataflower)
	public void onDataClicked(View v) {
		startActivity(new Intent(MeActivity.this, DataActivity1.class));
	}
	@OnClick(R.id.dataflower2)
	public void onDataClicked2(View v) {
		startActivity(new Intent(MeActivity.this, DataActivity2.class));
	}
