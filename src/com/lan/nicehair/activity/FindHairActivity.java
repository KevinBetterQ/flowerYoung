	    ...
	    mRadioGroup.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			...
			public void onCheckedChanged(RadioGroup group, int checkedId) {
				...
				case R.id.btn_main_topic_tag:
					...
					break;
				case R.id.btn_video_tag:
					mViewPager.setCurrentItem(3);
					break;
				case R.id.btn_data_tag:
					Intent openCameraIntent1 = new Intent(FindHairActivity.this,DataActivity1.class);
					FindHairActivity.this.startActivity(openCameraIntent1);
					break;
				}
			}
		});
	    mViewPager.setOnPageChangeListener(new OnPageChangeListener() {
			...
			public void onPageSelected(int position) {
				...
				case 2:
					...
					break;
				case 3:
					mRadioGroup.check(R.id.btn_video_tag);
					break;
				case 4:
					mRadioGroup.check(R.id.btn_data_tag);
					break;
				}
			}
