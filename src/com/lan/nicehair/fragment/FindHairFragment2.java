...
public class FindHairFragment2 extends Fragment implements IXListViewListener{
	...
	public static FindHairFragment2 newInstance(int position) {
		FindHairFragment2 fragment = new FindHairFragment2();
	...
	private void initWeb(View contentV) {
       ...
       webView.setWebViewClient(new WebViewClient(){
    	...
    	public void onPageFinished(WebView view, String url) {
    		// TODO Auto-generated method stub
    		   if(url!=null&&url.contains("huabaike.com")) {
                   String fun="javascript:function getClass(parent,sClass) { var aEle=parent.getElementsByTagName('div'); var aResult=[]; var i=0; for(i<0;i<aEle.length;i++) { if(aEle[i].className==sClass) { aResult.push(aEle[i]); } }; return aResult; } ";
                   view.loadUrl(fun);
                   String fun2="javascript:getClass(document,'hua mbhd')[0].style.display='none';";
                   view.loadUrl(fun2);
                   String fun3="javascript:getClass(document,'xfDiv')[0].style.display='none';";
                   view.loadUrl(fun3);
     ...
     //WebView加载web资源
       webView.loadUrl("http://m.huabaike.com/hhzl");
	}
