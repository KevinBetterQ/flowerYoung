...
public class FindHairFragment4 extends Fragment implements IXListViewListener{
	...
	public static FindHairFragment4 newInstance(int position) {
		FindHairFragment4 fragment = new FindHairFragment4();
	...
	private void initWeb(View contentV) {
       ...
       webView.setWebViewClient(new WebViewClient(){
    	...
    	public void onPageFinished(WebView view, String url) {
    		// TODO Auto-generated method stub
    		   if(url!=null&&url.contains("m.iqiyi.com")) {
                   String fun="javascript:function getClass(parent,sClass) { var aEle=parent.getElementsByTagName('div'); var aResult=[]; var i=0; for(i<0;i<aEle.length;i++) { if(aEle[i].className==sClass) { aResult.push(aEle[i]); } }; return aResult; } ";
                   view.loadUrl(fun);
                   String fun2="javascript:getClass(document,'m-box-items m-box-items-full')[0].style.display='none';";
                   view.loadUrl(fun2);
                   String fun3="javascript:document.getElementById('headerEl').style.display='none';";
                   view.loadUrl(fun3);
     ...
     //WebView加载web资源
       webView.loadUrl("http://m.iqiyi.com/search.html?key=%e5%85%bb%e8%8a%b1#");
	}
