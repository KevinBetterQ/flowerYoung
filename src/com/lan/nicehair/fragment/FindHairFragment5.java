...
public class FindHairFragment5 extends Fragment implements IXListViewListener{
	...
	public static FindHairFragment5 newInstance(int position) {
		FindHairFragment5 fragment = new FindHairFragment5();
