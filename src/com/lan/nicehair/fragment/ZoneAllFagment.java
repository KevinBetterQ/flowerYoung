...
public class ZoneAllFagment extends Fragment implements OnClickListener,IHListViewListener{
	...
	private void initWeb(View contentV) {
    	...
    	public void onPageFinished(WebView view, String url) {
    		// TODO Auto-generated method stub
    		   if(url!=null&&url.contains("huajiang.cc")) {
                   ...
                   view.loadUrl(fun);
                   String fun2="javascript:getClass(document,'bar_nav_wrap')[0].style.display='none';";
                   view.loadUrl(fun2);
                   String fun3="javascript:document.getElementById('j_artcileMain').style.display='none';";
                   view.loadUrl(fun3);
     ...
     //WebView加载web资源
       webView.loadUrl("http://m.huajiang.cc/list/17.html");
	}
