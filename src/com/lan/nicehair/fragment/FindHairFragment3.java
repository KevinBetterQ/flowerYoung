...
public class FindHairFragment3 extends Fragment implements IXListViewListener{
	...
	public static FindHairFragment3 newInstance(int position) {
		FindHairFragment3 fragment = new FindHairFragment3();
	...
	private void initWeb(View contentV) {
     ...
     //WebView加载web资源
       webView.loadUrl("http://www.huayoue.com/forum-55-1.html");
	}
