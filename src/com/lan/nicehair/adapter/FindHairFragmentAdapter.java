...
import com.lan.nicehair.fragment.FindHairFragment2;
import com.lan.nicehair.fragment.FindHairFragment3;
import com.lan.nicehair.fragment.FindHairFragment4;
import com.lan.nicehair.fragment.FindHairFragment5;
...
public class FindHairFragmentAdapter extends FragmentPagerAdapter {
	...
	public Fragment getItem(int position) {
		...
		case 1:
			return FindHairFragment2.newInstance(position);
		case 2:
			return FindHairFragment3.newInstance(position);
		case 3:
			return FindHairFragment4.newInstance(position);
		case 4:
			return FindHairFragment5.newInstance(position);
		}
		return null;
	}
